class DelayTimer {
    ...
    timeUntilInvocation(strTime) {
        ...
        let currentDayAtZero = new Date(Date.now());
        currentDayAtZero = this.dayAtZero(currentDayAtZero);
        currentTime = currentTime.getTime();
        currentDayAtZero = currentDayAtZero.getTime();
        let millisecondsToDesiredTimeFromMidnight = this.timeStringToMilliseconds(strTime);
        console.log("milliseconds from midnight", millisecondsToDesiredTimeFromMidnight);
        console.log("current time in milliseconds from today at midnight", currentDayAtZero);
        let desiredInovocationTimeForToday = currentDayAtZero + millisecondsToDesiredTimeFromMidnight;
        if (this.hasTimePassed(desiredInovocationTimeForToday)) {
            ...
            console.log("currenttimein milliseconds", currentTime);
            console.log("tomorrowatMidnight", this.getTomorrowAtMidnight());
